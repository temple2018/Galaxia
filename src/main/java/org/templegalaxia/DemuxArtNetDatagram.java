...
public class DemuxArtNetDatagram extends LXDatagram {
        ...
        public DemuxArtNetDatagram(LXFixture fixture, int var2) {
            this(fixtureToIndices(fixture), var2);
        }
        ...
        static int[] fixtureToIndices(LXFixture var0) {
            ...
            LXPoint var5;
            for(Iterator pointsIter = points.iterator(); pointsIter.hasNext(); indices[var3++] = var5.index) {
