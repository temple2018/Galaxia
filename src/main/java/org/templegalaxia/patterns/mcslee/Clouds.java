...
public class Clouds extends TemplePattern {
  ...
  public final CompoundParameter speed =
      new CompoundParameter("Range", 5, 1, 10).setDescription("Range of the cloud motion");

  public final CompoundParameter value =
      new CompoundParameter("Value", .5)
          .setDescription("Value to be modulated to generate randomness in the rising cloud");

  public final CompoundParameter contrast =
      new CompoundParameter("Constrast", 1, 1, 4).setDescription("Amount to increase contrast by");

  private final HistoryBuffer history =
      new HistoryBuffer("History", 4096) {
        @Override
